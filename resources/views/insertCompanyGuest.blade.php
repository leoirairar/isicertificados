            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('insertCompanyGuest') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="sector_economico"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Sector económico') }}<label
                                        for="" class="" style="color: red;"> *</label></label></label>
                                <div class="col-md-6">
                                    <select
                            ...
                            <div class="mt-5 mb-4">
                                <h3>Datos del administrador de la empresa</h3>
