...
<div class="">
   <div class="">
      <div class="col-md-12">
         <div class="card">
            <div class="card-header" style="font-weight: bold">Finalización de curso</div>
            @if (session('error'))
            ...
            <div class="card-body">
                  <div class="">
                     <div class="row">
                        <div class="col-sm-12">
                           <form amethod="POST" class="form-inline" action="{{ route('getViewCourseFinalizationByDates') }}">
                              @csrf
                     ...
                     <div class="row">
                         <div class="col-sm-8 mt-3">
                           <select class="form-control col-md-12" name="programmedCourses" id="programmedCourses">
                              ...
                              <option value="{{ $courseProgrammed->id }}">{{ $courseProgrammed->course->name.' - Inicio '.\Carbon\Carbon::parse($courseProgrammed->begin_date)->format('d/m/Y').(($courseProgrammed->group != 0)?' - Grupo  '.$courseProgrammed->group:'')}}</option>
                              @endforeach
                           </select>  
                         </div>
                     </div>
...
@endsection
@section('scripts')
<script src="{{ asset('js/app/endCourse.js') }}"></script>
@endsection
